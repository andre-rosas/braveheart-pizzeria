              ...
              {editUser ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="bg-scotland-blue text-white font-medium text-center cursor-pointer py-2 px-3 rounded-md shadow-md text-lg block mx-auto w-4/5 my-7 border border-scotland-blue hover:bg-white hover:text-scotland-blue hover:border-2 hover:border-scotland-blue"
                  >
                    Edit User
                  </button>
                </>
          ...
          <ul className="py-3 text-center rounded-md shadow-md w-full mx-auto block">
            <li
              className={
                "w-full " +
                (showUser
                  ? "bg-scotland-blue text-white "
                  : "bg-white text-scotland-blue") +
